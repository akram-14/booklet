import 'package:booklet/details.dart';
                ...
                children: <Widget>[
                  Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow (
                          offset: Offset(3, 3),blurRadius: 10,)
                      ]),
                    child: CircleAvatar(backgroundImage: AssetImage("images/pic1.jpg"),
                    ),
                    ),
                  GradientText ("BOOKS",
                  ...
                  Expanded(
                      child: ListView.separated(
                        physics: BouncingScrollPhysics(),
                          ...
                          return listItem (image: "images/pic$index.jpg", tag:"tag$index");
                          },
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Expanded(child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 10,),
              Text("Books title", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
              ),
              SizedBox(height: 5,),
              Text("Auther name",style: TextStyle(color: Colors.black45),),
              SizedBox(height: 5,
              ),
              Row(
                children: <Widget>[
  ...
  Widget makeItem({image}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              offset: Offset(5,5), blurRadius: 10),
        ],
      ),
